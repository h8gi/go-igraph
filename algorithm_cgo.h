...
igraph_error_t go_igraph_simplify(
    igraph_t *, igraph_bool_t, igraph_bool_t,
    const igraph_attribute_combination_t *);
igraph_error_t go_igraph_to_directed(igraph_t *, igraph_to_directed_t);
igraph_error_t go_igraph_to_undirected(
    igraph_t *, igraph_to_undirected_t,
    const igraph_attribute_combination_t *);
...
igraph_error_t go_igraph_get_shortest_paths(
    ...
    igraph_vector_int_list_t *, igraph_int_t, igraph_vs_t, igraph_neimode_t);
igraph_error_t go_igraph_get_k_shortest_paths(
    const igraph_t *, const igraph_vector_t *, igraph_vector_int_list_t *,
    igraph_vector_int_list_t *, igraph_int_t, igraph_int_t, igraph_int_t,
    igraph_neimode_t);
...
igraph_error_t go_igraph_get_widest_paths(
    const igraph_t *, igraph_vector_int_list_t *, igraph_vector_int_list_t *,
    igraph_int_t, igraph_vs_t, const igraph_vector_t *, igraph_neimode_t);
...
igraph_error_t go_igraph_voronoi(
    const igraph_t *, igraph_vector_int_t *, igraph_vector_t *,
    const igraph_vector_int_t *, const igraph_vector_t *, igraph_neimode_t,
    igraph_voronoi_tiebreaker_t);
igraph_error_t go_igraph_spanner(
    const igraph_t *, igraph_vector_int_t *, igraph_real_t,
...
igraph_error_t go_igraph_transitivity_barrat(
    const igraph_t *, igraph_vector_t *, igraph_vs_t,
    const igraph_vector_t *, igraph_transitivity_mode_t);
igraph_error_t go_igraph_ecc(
    const igraph_t *, igraph_vector_t *, igraph_es_t, igraph_int_t,
    igraph_bool_t, igraph_bool_t);
...
igraph_error_t go_igraph_betweenness_subset(
    const igraph_t *, const igraph_vector_t *, igraph_vector_t *,
    igraph_vs_t, igraph_vs_t, igraph_vs_t, igraph_bool_t);
igraph_error_t go_igraph_edge_betweenness_subset(
    const igraph_t *, const igraph_vector_t *, igraph_vector_t *,
    igraph_vs_t, igraph_vs_t, igraph_es_t, igraph_bool_t);
igraph_error_t go_igraph_constraint(
    const igraph_t *, igraph_vector_t *, igraph_vs_t,
    const igraph_vector_t *);
igraph_error_t go_igraph_convergence_degree(
    const igraph_t *, igraph_vector_t *, igraph_vector_t *,
    igraph_vector_t *);
